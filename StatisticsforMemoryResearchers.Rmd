...
i = different memories, y = logRT, b0 = intercept, b1 = retrieval type and e = error. For this analysis, yi is the logarithm of retrieval time from memory i and xi is the retrieval strategy used. ei is assumed to be independent and Normally distributed.
...
Note the only difference between this random intercept model and the linear model above, is the inclusion of the term (1|Subject). This term denotes that an intercepts (1) will be calculated for each Participant.
